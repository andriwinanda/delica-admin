        ...
        <div class="row">
          <div class="columns">
            ...
            <div class="column is-6 is-align-item-center is-justify-content-center has-text-centered">
              ...
              <p class="is-size-7 has-text-grey">Tambahkan material dan jumlah daun pintu <br>
  ...
  methods: {
    submitForm() {
      ...
      if (data.name && data.description) {
        this.isLoading = true;
        if (this.id) {
          data.idMaterial = this.id
          submit = this.axios.put(`/api/material`, data);
        } else {
          submit = this.axios.post( "/api/material", data);
        }
        submit
          .then(res => {
